...
struct InformationResult: Hashable, Identifiable {
     ...
     */
    func toInformation(info: ImageInfo) -> Information {
        return Information(id: id, title: title, subtitle: subtitle, description: description, image: ImageX(path: info.path, url: info.url, belongs: belongs), place: place)
    }
}
