        ...
        uploadImageToFirebaseWithProcessHandler(for: path, with: compressedImageData, progressHandler: { progress in
            ...
            DispatchQueue.main.async {
                ...
                if let imageInfo = imageInfo {
                    ...
                    let store = StoreDto(id: store.id, name: name, image: image, address: address, phoneNumber: phoneNumber, emailAddress: emailAddress, website: website, description: description, returnPolicy: returnPolicy, refundPolicy: refundPolicy, brands: brands.components(separatedBy: ","), status: status)
